...
componentDidMount(){
  ...
  handleInputChange = ({target: {name,value}}) => {
    ...
    render() {
      ...
      const {title, city, date, venue, hostedBy, description} = this.state;
        return (
                  <Segment>
                    <Form onSubmit={this.handleFormSubmit} autoComplete = 'off' >
                      ...
                      <Form.Field>
                        ...
                        <input name='description' onChange={this.handleInputChange} value={description} placeholder="Enter Description" />
                      </Form.Field>
